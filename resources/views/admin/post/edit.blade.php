        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{ trans('post.edit_post') }}</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input Title--}}
                                {!! Form::text('title', $post->title, ['id' => 'title', 'class' => 'form-control col-md-7 col-xs-12 input_slug', 'placeholder' => trans('post.place_title')]) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--input slug--}}
                                {!! Form::text('slug', $post->slug, ['class' => 'form-control col-md-7 col-xs-12 output_slug', 'placeholder' => trans('post.place_slug')]) !!}
                        ...
                        <div class="item form-group {{ $errors->has('desc') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input desc--}}
                                {!! Form::textarea('desc', $post->desc, ['id' => 'desc', 'rows' => 4, 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => trans('post.place_desc')]) !!}
                        ...
                        <div class="item form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input content--}}
                                {!! Form::textarea('content', $post->content, ['id' => 'content', 'class' => 'form-control col-md-7 col-xs-12 article-ckeditor', 'placeholder' => trans('post.place_content')]) !!}
                        ...
                        <div class="item form-group {{ $errors->has('categories') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--select--}}
                                {!! Form::select('category_id', $categories, $selectedCategories, ['class' => 'form-control', 'placeholder' => '']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="{{url()->previous()}}" class="btn btn-primary">{{ trans('post.cancel') }}</a>
