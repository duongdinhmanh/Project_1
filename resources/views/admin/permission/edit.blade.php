            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        {{--Open Form--}}
                        {!! Form::open(['method' => 'PUT', 'route' => ['permissions.update', $permission->id],'class' => 'form-horizontal form-label-left']) !!}
                        <span class="section">Permission Edit</span>
                        ...
                        <div class="item form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input name--}}
                                {!! Form::text('name', $permission->name, ['id' => 'name', 'class' => 'form-control col-md-7 col-xs-12',
                        ...
                        <div class="item form-group {{ $errors->has('display_name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input name--}}
                                {!! Form::text('display_name', $permission->display_name, ['id' => 'display_name', 'class' => 'form-control col-md-7 col-xs-12',
                        ...
                        <div class="item form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input name--}}
                                {!! Form::text('description', $permission->description, ['id' => 'description', 'class' => 'form-control col-md-7 col-xs-12',
