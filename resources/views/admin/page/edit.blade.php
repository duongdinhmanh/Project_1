            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        {{--Open Form--}}
                        {!! Form::model($page, ['method' => 'PUT', 'route' => ['pages.update', $page->id],'class' => 'form-horizontal form-label-left']) !!}
                        <span class="section">{{ trans('page.title_edit') }}</span>
                        ...
                        <div class="item form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            {{--lable Title:--}}
                            {!! htmlspecialchars_decode(Form::label('title', trans('page.lable_title') . ' <span class="required">*</span>', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12'])) !!}
                        ...
                        <div class="item form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                            {{--lable slug--}}
                            {!! htmlspecialchars_decode(Form::label('slug', trans('page.label_slug') . ' <span class="required">*</span>', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12'])) !!}
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--input slug--}}
                        ...
                        <div class="item form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                            {{--lable content:--}}
                            {!! htmlspecialchars_decode(Form::label('content', trans('page.label_content') . ' <span class="required">*</span>', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12'])) !!}
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{--Input content--}}
                                {!! Form::textarea('content', old('content'), ['id' => 'content','class' => 'form-control col-md-7 col-xs-12 article-ckeditor', 'placeholder' => trans('page.place_content')]) !!}
                        ...
                        <div class="item form-group">
                            {{--label status--}}
                            {!! htmlspecialchars_decode(Form::label('status_about_us',trans('page.label_status') . ' <span class="required">*</span>', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12'])) !!}
