        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{ trans('about_us.edit_aboutus') }}</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        {{--Open Form--}}
                        {!! Form::model($aboutUs, ['method' => 'PUT', 'route' => ['about_us.update', $aboutUs->id],'class' => 'form-horizontal form-label-left']) !!}
                        <span class="section">{{ trans('about_us.title_edit') }}</span>
